...
class VoxCPM:
    def __init__(self,
        ...
        self.tts_model = VoxCPMModel.from_local(voxcpm_model_path, optimize=optimize, device=device, dtype=dtype)
    ...
    def generate(self, *args, **kwargs) -> np.ndarray:
        # Non-streaming: directly return final waveform
    ...
    def _generate(self, 
        ...
        try:
            ...
            decode_audio, target_text_token, pred_audio_feat = next(self.tts_model._generate_with_prompt_cache(
                            target_text=text,
            ...
            return decode_audio.squeeze(0).cpu().numpy()
